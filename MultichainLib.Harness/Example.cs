...
namespace MultiChainLib.Harness
{
    public class Example
    {
        ...
        internal async Task RunAsync()
        {
            ...
            var client = new MultiChainClient("188.166.224.250", 4754, false, "multichainrpc", "6tTGNtRqLtGzMXvf54AqARgEH3gmLxSuDbquJUSgj2Ko", "chain1");
            ...
            //var recipient = "118iVmftxt5pDQpQKHVAEDeYmULBiHDgRDV7vF";
            // send with metadata...
            Console.WriteLine("*** sendwithmetadata ***");
            var bs = Encoding.UTF8.GetBytes("Hello, world.");
            var sendResult = await client.SendWithMetadataExAsync(recipient, new Dictionary<string, object>() { 
                {"litecoin", 1},
                {"bitcoin", 2}
            }, bs);
            sendResult.AssertOk();
